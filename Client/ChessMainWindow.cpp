...
void ChessMainWindow::initUI() { newGame(); }

void ChessMainWindow::newGame() {
  _model->newGame();
  generateTable();
}

void ChessMainWindow::generateTable() {
  int i = 0;
...
void ChessMainWindow::updateCell(int x, int y, ChessField field,
                                 bool initField) {
  if (initField) {
...
void ChessMainWindow::onGameOver(int Player) {
  if (Player == 0) {
...
void ChessMainWindow::onCellClicked(int x, int y) {
...
void ChessMainWindow::onPawnHasReachedEnemysBase(int x, int y) {
